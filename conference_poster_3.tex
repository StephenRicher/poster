...
\captionof{figure}{
HiC interaction map, summed across 2 replicates, for HB2 (top) and MCF7 (bottom).
}
\end{center}
%------------------------------------------------
...
\captionof{figure}{
Log\textsubscript{2} FC of MCF7 over HB2 with differential interactions. \textcolor{red}{Red} = increase in MCF7.
}
\end{center}
